...
public class BeanMapUtils {
    private static final Logger logger = Logger.getLogger(BeanMapUtils.class);
    private static Map<String, String> beanMap = new HashMap<>();
    static {
        ClassPathResource configJson = new ClassPathResource("bean_map.json");
        try {
            BufferedReader bf = new BufferedReader(new InputStreamReader(configJson.getInputStream(),"utf-8"));
