...
import com.puputuan.generic.permission.service.*;
...
public class AuthorityServiceImpl implements AuthorityService {
    ...
    @Resource(name = "permissionUrlService")
    ...
    public boolean setRoleForUser(Long userId, Long roleId) {
        ...
        if (userRoleRelativeList != null && !userRoleRelativeList.isEmpty()) {
            return false;
        }
    ...
    public boolean removeRoleFromUser(Long userId, Long roleId) {
        ...
        if (geetionRoleList != null && !geetionRoleList.isEmpty()) {
