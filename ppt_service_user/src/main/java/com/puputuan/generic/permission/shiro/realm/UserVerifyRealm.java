package com.puputuan.generic.permission.shiro.realm;
...
import com.puputuan.generic.permission.shiro.Constants;
...
public class UserVerifyRealm extends AuthorizingRealm {
    private static Logger logger = Logger.getLogger(UserVerifyRealm.class);
    ...
    @Resource(name = "userRoleRelativeService")
    private UserRoleRelativeService userRoleRelativeService;

    @Resource(name = "rolePermissionRelativeService")
...
//        String account = (String) super.getAvailablePrincipal(principals);
        logger.info("赋予权限：" + ReflectionToStringBuilder.toString(principals, ToStringStyle.MULTI_LINE_STYLE));
...
//        为当前用户设置角色和权限
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) throws AuthenticationException {
        ...
        if (token.getHost().equals("ctrl")) {
            userBase.setToken(UuidUtils.generateUuid().replaceAll("-", ""));
